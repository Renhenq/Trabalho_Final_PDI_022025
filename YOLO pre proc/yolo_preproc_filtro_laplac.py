...
preprocessed = cv2.filter2D(contraste, -1, kernel_sharpen)

# ----------------------------
# DETECÇÃO
# ----------------------------
output = preprocessed.copy()
output = contraste.copy()
...
base = base / "resultados" / "filtro_laplac"
...
cv2.imwrite(os.path.join(pasta, "04_preprocessed_filtro_laplac.jpg"), preprocessed)
